...
/***/ "./tool-frontend/d3js_modules/d3.v3.min.js":
/*!*************************************************!*\
  !*** ./tool-frontend/d3js_modules/d3.v3.min.js ***!
  \*************************************************/
...
function (_super) {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [4
            /*yield*/
            , Object(_FormNetwork__WEBPACK_IMPORTED_MODULE_2__["getNetworkData"])(data.series, prometheus_metrics, business_metrics)];
          ...
          case 4:
            ...
            if (result.length > 0) this.drawGraph(result);else return [2
            /*return*/
            ];
            _a.label = 5;
  ...
  App.prototype.drawGraph = function (metrics_data) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      ...
      var dataset, width, height, d3, force, svg, path, node, svg, arc, arc2, arc3, arc4;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        dataset = {
        ...
        .attr("id", String).attr("viewBox", "0 -5 10 10").attr("refX", 40).attr("refY", -4.5).attr("markerWidth", 9).attr("markerHeight", 7).attr("orient", "auto").append("svg:path").attr("d", "M0,-5L10,0L0,5");
        ...
        //.attr("class", "link")
        .style("fill", "none").style("stroke", "#666").style("stroke-width", "1.5px").attr("marker-end", "url(#end)");
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            console.log(res); //const res = await fetch(url, {headers});
...
function getNetworkData(data, data_, data__) {
  ...
  var businessMetrics = data__;
  console.log("businessMetrics insdie FormNetwork");
  console.log(businessMetrics); //list.sort((a, b) => (a.color > b.color) ? 1 : -1)
  ...
  if (data[0].fields[0].values.length > 0 && data[0].fields[0]["name"] == "Parent" && data[0].fields[1]["name"] == "Child" && data[0].fields[2]["name"] == "CallCount") {
    ...
    var callCountArr = data[0].fields[2].values.toArray(); //var min_scale = 1;
    //var max_scale = 6;
    ...
    for (var k = 0; k < len(businessMetrics); ++k) {
      if (uniqueNodes.includes(businessMetrics[k][0])) {
        ...
        nodes.push({
          ...
          effort_spent: effort,
          open_to_closed_issues: open_to_closed_issues_ratio,
          open_to_closed_bugs: open_to_closed_bugs_ratio,
          cost_to_revenue: cost_to_revenue_ratio,
          service_response_time: response_time,
          service_load_1m: load_1m
        });
      }
    }
    ...
    for (var i = 0; i < len(parentNodes); ++i) {
      var source_ = -1;
      var target_ = -1;
      var calls_ = 0;

      for (var j = 0; j < nodes.length; ++j) {
        if (parentNodes[i] == nodes[j].name) source_ = j;
      ...
      if (source_ > -1 && target_ > -1) links.push({
        source: source_,
        target: target_,
        calls: calls_
      });
