      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            api_token = "Bearer eyJrIjoiSExRaDJCaEtURWVPRWl0cWg3QUh0M0hFSFQ2OFRCTU8iLCJuIjoiZHNfa2V5IiwiaWQiOjF9";
            headers = {
    ...
    for (var k = 0; k < len(businessMetrics); ++k) {
      if (uniqueNodes.includes(businessMetrics[k][0])) {
        ...
        nodes.push({
          ...
          effort_spent: normalized_effort,
...
function measureScalingFactor(x, minScale, maxScale, minVal, maxVal) {
