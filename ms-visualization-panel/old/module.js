...
/* harmony import */ var _DrawGraph__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DrawGraph */ "./tool-frontend/src/DrawGraph.tsx");
...
function (_super) {
  ...
  App.prototype.render = function () {
    ...
    if (data.series.length < 1) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, "Data not available...");
    } else {
      Object(_DrawGraph__WEBPACK_IMPORTED_MODULE_3__["drawGraph"])(data.series); //drawGraph("hello");
    }

    console.log("data series from type script");
    console.log(data.series);
    console.log(data.series[0]);
    console.log("data.series[0].fields");
    console.log(data.series[0].fields);
    console.log(_typeof(data.series[0].fields)); //console.log(typeof((data.series)[0].fields[0].values));

    console.log("(data.series)[0].fields[0].values");
    console.log(data.series[0].fields[0].values); //console.log((data.series)[0].fields[0].values["buffer"]);

    console.log("printing key value for data.series[0].fields[0]['name']");
    console.log(data.series[0].fields[0]["name"]);
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      id: "data"
...
/***/ "./tool-frontend/src/DrawGraph.tsx":
/*!*****************************************!*\
  !*** ./tool-frontend/src/DrawGraph.tsx ***!
  \*****************************************/
/*! exports provided: drawGraph, DrawGraph */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*export class DrawGraph extends Component<Props> {
...
//void export function drawGraph (data: dataType) : DataFrame[] {
function drawGraph(data) {
  console.log("Printing data from inside drawGraph function in DrawGraph.tsx"); //console.log(this.props);
